...
class LengthConstrainedBeamSearch(Search):
    ...
    def __init__(self, eos_index, min_len_a, min_len_b, max_len_a, max_len_b):
        super().__init__(eos_index)
        self.min_len_a = min_len_a
        self.min_len_b = min_len_b
        self.max_len_a = max_len_a
        self.max_len_b = max_len_b
        self.beam = BeamSearch(eos_index)
...
class DiverseBeamSearch(Search):
    ...
    def __init__(self, eos_index, num_groups, diversity_strength):
        super().__init__(eos_index)
...
class Sampling(Search):
    ...
    def __init__(self, eos_index, sampling_topk=-1, sampling_temperature=1.):
        super().__init__(eos_index)
