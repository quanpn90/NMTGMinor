...
import nmtg.optim
from nmtg.optim import Optimizer
...
class FP16Optimizer(Optimizer):
    ...
    def clip_grad_norm(self, max_norm):
        ...
        grad_norm = torch.nn.utils.clip_grad_norm_(self.fp32_params.grad.data, max_norm)
...
class MemoryEfficientFP16Optimizer(Optimizer):
    """
    Wrap an *optimizer* to support FP16 (mixed precision) training.
    ...
    def build_optimizer(cls, args, params):
        ...
        fp16_optimizer = optimizer_class._build_optimizer(args, params)
