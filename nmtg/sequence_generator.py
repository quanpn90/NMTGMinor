...
class SequenceGenerator:
    ...
    def generate(self, encoder_input, source_lengths, encoder_mask=None, gold_prefix=None, bos=None):
        ...
        """
        with torch.no_grad():
            return self._generate(encoder_input, source_lengths, encoder_mask, gold_prefix, bos)

    def _generate(self, encoder_input, source_lengths, encoder_mask=None, gold_prefix=None, bos=None):
        """See generate"""
