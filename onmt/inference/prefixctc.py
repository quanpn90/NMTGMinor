...
class CTCPrefixScoreTH(object):
    ...
    def __init__(self, x, xlens, blank, eos, margin=0):
        ...
        :param torch.Tensor x: input label posterior sequences (B, T, O) obtained by softmax ctc outputs
        :param torch.Tensor xlens: input lengths (B,)
        :param int blank: blank label id (<pad> in the mbart configuration?)
        :param int eos: end-of-sequence id (<eos> ??)
        ...
        # maybe we should repeat the B dimension of x by beam size times
    ...
    def __call__(self, y, state, scoring_ids=None, att_w=None):
        ...
        # f_min and f_max should be fine
        # should we also index_select "self.x"
