...
std::vector<torch::Tensor> bwd_bias_cuda_recompute(
                               bool use_time_mask,
                               int                  heads,
                               torch::Tensor const& output_grads,
                               torch::Tensor const& inputs,
...
std::vector<torch::Tensor> bwd_bias_recompute(
                               bool use_time_mask,
                               int                  heads,
                               torch::Tensor const& output_grads,
                               torch::Tensor const& inputs,
                                                  ...
                                                  )
{
  ...
  return bwd_bias_cuda_recompute(
                                 use_time_mask,
                                 heads,
                                 output_grads,
                                 inputs,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &multihead_attn::self_bias::cublaslt::fwd_bias, "Self Multihead Attention with Bias -- Forward.");
  m.def("backward", &multihead_attn::self_bias::cublaslt::bwd_bias, "Self Multihead Attention with Bias -- Backward.");
  m.def("backward_recompute", &multihead_attn::self_bias::cublaslt::bwd_bias_recompute, "Self Multihead Attention with Bias -- Backward.");
