...
#include "dynamic_conv_cuda_forward.cu"
#include "dynamic_conv_cuda_backward.cu"
#include "cuda_utils.cu"

// FS is filter size and kernels are specialized for filter sizes
template<int FS, int SB, int padding_l, typename scalar_t>
__global__
void dynamic_conv_forward_kernel(const scalar_t* input,
...
template<int FS, int SB, int padding_l, typename scalar_t>
__global__
void dynamic_conv_backward_kernel(
