...
from onmt.modules.IIDStochasticTransformer.Layers import IIDStochasticEncoderLayer, IIDStochasticDecoderLayer
...
class IIDStochasticTransformerEncoder(TransformerEncoder):
    ...
    def __init__(self, opt, dicts, positional_encoder):
        ...
        print("IIDStochastic Encoder with %.2f expected layers" % e_length) 
    ...
    def build_modules(self):
        ...
        for l in range(self.layers):
            ...
            block = IIDStochasticEncoderLayer(self.n_heads, self.model_size, self.dropout, self.inner_size, self.attn_dropout, death_rate=death_r)
            
            self.layer_modules.append(block)

class IIDStochasticTransformerDecoder(TransformerDecoder):
    """Encoder in 'Attention is all you need'
    ...
    def __init__(self, opt, dicts, positional_encoder):
        ...
        print("IIDStochastic Decoder with %.2f expected layers" % e_length) 
    ...
    def build_modules(self):
        ...
        for l in range(self.layers):
            ...
            block = IIDStochasticDecoderLayer(self.n_heads, self.model_size, self.dropout, self.inner_size, self.attn_dropout, death_rate=death_r)
