...
class Trainer(object):
    ...
    def __init__(self, model, loss_function, train_data, valid_data, dicts, opt):
        ...
        self.model_wrapper = MultiprocessingRunner(opt, model, loss_function, device_ids=opt.gpus)
    ...
    def eval(self, data):
        ...
        with torch.no_grad():
            ...
            while not data_iterator.end_of_epoch():
                ...
                logging_output = self.model_wrapper.forward(samples, eval=True, backward=False)

                loss_data = logging_output['loss']
                total_words += logging_output['tgt_size']
