...
def main():
    if not opt.multi_dataset:
        ...
        # Loading asr data structures
            ...
            # also add the train auxiliary target
            train_aux_tgt = MMapIndexedDataset(train_path + '.aux_tgt')
            ...
            if os.path.exists(train_path + '.src_sizes.npy'):
                ...
                train_aux_tgt_sizes = np.load(train_path + '.aux_tgt_sizes.npy')
            else:
            ...
            train_data = onmt.TripletDataset( train_src,
                                              train_tgt, train_aux_tgt,
                                              train_src_sizes, train_tgt_sizes, train_aux_tgt_sizes,
                                              train_src_langs, train_tgt_langs,
                                              train_src_atbs, train_tgt_atbs,
                                              batch_size_words=opt.batch_size_words,
                                              batch_size_frames=opt.batch_size_frames,
            ...
            valid_aux_tgt = MMapIndexedDataset(valid_path + '.aux_tgt')
            ...
            if os.path.exists(valid_path + '.src_sizes.npy'):
                ...
                valid_aux_tgt_sizes = np.load(valid_path + '.aux_tgt_sizes.npy')
            else:
                valid_src_sizes, valid_tgt_sizes, valid_aux_tgt_sizes = None, None
            ...
            valid_data = onmt.TripletDataset(valid_src, valid_tgt, valid_aux_tgt_sizes,
    ...
    # Multi-data set handling
        ...
        for (idx_, dir_) in sorted(train_dirs.items()):
            ...
            if opt.data_format in ['bin', 'raw']:
                ...
                aux_tgt_data = MMapIndexedDataset(os.path.join(data_dir, "data.aux_tgt"))
                ...
                if os.path.exists(os.path.join(data_dir, 'data.src_sizes.npy')):
                    ...
                    aux_tgt_sizes = np.load(os.path.join(data_dir, 'data.aux_tgt_sizes.npy'))
                else:
                    src_sizes, tgt_sizes, aux_tgt_sizes = None, None, None
                ...
                train_data = onmt.TripletDataset( src_data,
                                                  tgt_data, aux_tgt_data,
                                                  src_sizes, tgt_sizes, aux_tgt_sizes,
        ...
        for (idx_, dir_) in sorted(valid_dirs.items()):
            ...
            if opt.data_format in ['bin', 'raw']:
                ...
                tgt_data = MMapIndexedDataset(os.path.join(data_dir, "data.tgt"))
                aux_tgt_data = MMapIndexedDataset(os.path.join(data_dir, "aux_data.tgt"))
                ...
                valid_data = onmt.DatasTriplet(src_data, tgt_data, aux_tgt_data,
                                          src_sizes, tgt_sizes, aux_tgt_sizes,
                                          src_lang_data, tgt_lang_data,
                                          src_atbs_data, tgt_atbs_data,
                                          batch_size_words=opt.batch_size_words,
